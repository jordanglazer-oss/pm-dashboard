...
const POINT_METRICS: ScoringFormula[] = [
  ...
  // 52-week high/low — code unconfirmed; validate these candidates via the
  // snapshot probe, then collapse to the winner as high52w/low52w.
  { key: "hiA", formula: "P_PRICE_HIGH(-1Y,0)", note: "52w high candidate A" },
  { key: "hiB", formula: "P_PRICE_HIGH(-52W,0)", note: "52w high candidate B" },
  { key: "hiC", formula: "P_52WK_HIGH", note: "52w high candidate C" },
  { key: "hiD", formula: "FG_PRICE_HIGH_52WK", note: "52w high candidate D" },
  { key: "hiE", formula: "P_MAX_PRICE(-1Y,0)", note: "52w high candidate E" },
  { key: "loA", formula: "P_PRICE_LOW(-1Y,0)", note: "52w low candidate A" },
  { key: "loB", formula: "P_PRICE_LOW(-52W,0)", note: "52w low candidate B" },
  { key: "loC", formula: "P_52WK_LOW", note: "52w low candidate C" },
  { key: "loD", formula: "FG_PRICE_LOW_52WK", note: "52w low candidate D" },
  { key: "loE", formula: "P_MIN_PRICE(-1Y,0)", note: "52w low candidate E" },
