    ...
    >
      ...
      >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {e.subtitle && (
                      <div className="text-[11px] text-slate-500 truncate">{e.subtitle}</div>
                    )}
                  </div>
        ...
        <div className="border-t border-slate-100 px-4 py-2 flex items-center gap-3 text-[10px] text-slate-400">
          <span><kbd className="border border-slate-200 rounded px-1 py-px">↑</kbd> <kbd className="border border-slate-200 rounded px-1 py-px">↓</kbd> navigate</span>
          <span><kbd className="border border-slate-200 rounded px-1 py-px">↵</kbd> open</span>
          <span className="ml-auto"><kbd className="border border-slate-200 rounded px-1 py-px">⌘K</kbd> toggle</span>
        </div>
      </div>
    </div>
  );
...
function CategoryGlyph({ category }: { category: Entry["category"] }) {
  if (category === "stock") {
    return (
      <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-emerald-50 text-emerald-600 shrink-0">
  ...
  if (category === "action") {
    return (
      <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-amber-50 text-amber-600 shrink-0">
  ...
  return (
    <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-slate-100 text-slate-600 shrink-0">
